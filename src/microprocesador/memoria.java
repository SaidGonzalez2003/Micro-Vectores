...
public class memoria {
    ...
    public void enlaceCodigo(){
        // e=a+b+c+d
        this.escritura(0,  "000000000101");  // a=5 00
        this.escritura(1,  "000000000011");  // b=3 01
        this.escritura(2,  "000000000111");  // c=7 10
        this.escritura(3,  "000000001001");  // d=9 11
        this.escritura(4,  "000000000000");  // e   00
        this.escritura(5,  "000000000000");  //     01
        this.escritura(6,  "000000000000");  //     10  
